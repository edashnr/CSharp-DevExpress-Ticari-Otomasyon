...
using System.Data.SqlClient; // veritabanını bağladık
...
namespace Ticari_Otomasyon
{
    public partial class FrmFirmalar : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Firma Sisteme Kaydedildi", "Bilgi", MessageBoxButtons.OK,
        ...
        private void BtnGüncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Firma Bilgileri Güncellendi", "Bilgi", MessageBoxButtons.OK,
