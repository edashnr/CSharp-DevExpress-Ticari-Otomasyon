...
namespace Ticari_Otomasyon
{
    public partial class FrmAnaModül : Form
    {
        ...
        {
            if (fr == null || fr.IsDisposed) //sayfanın tek bir kere açolmasını sağlıycak
            {
                fr = new FrmUrunler();
                fr.MdiParent = this;
                fr.Show();
        ...
        private void BtnKasa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                fr14 = new FrmKasa();
                fr14.ad = kullanici;// ADMİNDE OLUSTURDUGUMUZ KULLANICIYE AD İSMİNİ ATADIK VE
                                    // KASA MODULUNE GITTIK
                fr14.MdiParent = this;
                fr14.Show();
            }
        }
        ...
        {
            // Kullanıcıya oturumu kapatmak isteyip istemediğini sormak için bir iletişim kutusu göster
            DialogResult result = MessageBox.Show("Oturumu kapatmak istediğinizden emin misiniz?", "Oturum Kapatma", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

            // Kullanıcı Evet'i seçerse, FrmAdmin formunu aç
